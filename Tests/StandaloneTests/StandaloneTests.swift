...
final class StandaloneTests: XCTestCase {
    ...
    /// Version string is expected to be "v" followed by semver (e.g. v0.2.1).
    ...
    func testCLIVersion() throws {
        ...
        XCTAssertTrue(Self.isVersionOutput(output), "Output should be a version string (e.g. v0.2.1). Got:\n\(output.prefix(200))")
    ...
    func testPluginVersion() throws {
        ...
        XCTAssertTrue(Self.isVersionOutput(output), "Plugin version output should be a version string (e.g. v0.2.1). Got:\n\(output.prefix(200))")
    }
